...
class CommandRunner:
    ...
    def _handle_sfdisk_simulation(self, cmd: List[str], result: subprocess.CompletedProcess, **kwargs) -> subprocess.CompletedProcess:
        ...
        # If dumping partition table
        if "--dump" in cmd:
            result.stdout = """label: gpt
...
/dev/sda1 : start=        2048, size=      526336, type=C12A7328-F81F-11D2-BA4B-00A0C93EC93B, uuid=aaaaaaaa-bbbb-cccc-dddd-1111111111, name="EFI System"
/dev/sda2 : start=      528384, size=     2097152, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, uuid=aaaaaaaa-bbbb-cccc-dddd-2222222222, name="Boot"
/dev/sda3 : start=     2625536, size=   974147599, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, uuid=aaaaaaaa-bbbb-cccc-dddd-3333333333, name="Linux System"
"""
